...
public class MovieRatingControllerUI {
    ...
    public String showRatingForm(@RequestParam(defaultValue = "0") int page,
                                 Model model,
    ...
    public String submitRatings(HttpServletRequest request, Authentication auth, Model model) {
